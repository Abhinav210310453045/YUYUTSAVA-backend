...
The plan source-of-truth lives at `$HOME/.claude/plans/i-want-you-to-snug-globe.md`. Read it once. This file tells you **what shipped in PR #1 (MVS)** and **what PRs #2–#4 still need to do**.
